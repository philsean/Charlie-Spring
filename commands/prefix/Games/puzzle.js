...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    let withoutTip = new EmbedBuilder().setCustomId('without').setLabel('Começar.').setStyle(ButtonStyle.Secondary);
    let withTip = new EmbedBuilder().setCustomId('with').setLabel('Começar com dicas.').setStyle(ButtonStyle.Primary);
